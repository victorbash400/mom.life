export type SimulatorProfile = { id: string; name: string; role: "adult" | "child" };
export type SimulatorConnection = { id: string; connected: boolean };
export type SimulatorMessage = { id: string; profile_id: string; direction: "incoming" | "outgoing"; body: string; created_at: string };
