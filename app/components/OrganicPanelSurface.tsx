...
export function OrganicPanelSurface() {
  return (
    <svg className={styles.surface} viewBox="0 0 1112 718" preserveAspectRatio="none" aria-hidden="true">
      ...
      <path
        d="M180 0 C320 0 416 72 556 72 C696 72 792 0 932 0 C1031 0 1112 81 1112 180 C1112 280 1084 315 1084 359 C1084 403 1112 438 1112 538 C1112 637 1031 718 932 718 C792 718 696 646 556 646 C416 646 320 718 180 718 C81 718 0 637 0 538 C0 438 28 403 28 359 C28 315 0 280 0 180 C0 81 81 0 180 0 Z"
        fill="url(#panel-fill)"
        stroke="#ffffff"
        strokeOpacity=".72"
        strokeWidth="2"
